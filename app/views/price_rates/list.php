<?php
//debug($data);
$page_link_prefix = "price_rates/list";
$suffix_terms = [];
                    ...
                    <div class="datatable-header">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                <a href="<?=$this->L("price_rates/add");?>" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add</a>
                            </div>
                            <?php
                            $html = "";
