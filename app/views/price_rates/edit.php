...
<header class="page-header page-header-left-inline-breadcrumb">
    <h2 class="font-weight-bold text-6"><a href="<?=$this->L("price_rates/list")?>" ><?= display($data['meta_name']); ?></a></h2>
...
<form class="ecommerce-form action-buttons-fixed" action="<?=$this->L("price_rates/edit_update")?>" method="post">
