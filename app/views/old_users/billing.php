...
<!--                        <a href="/--><?php //echo $this->lang ?><!--/users/billing" class="list-group-item list-group-item-action clearfix active">Στοιχεία Τιμολόγησης <i class="icon-credit-cards float-right"></i></a>-->
                ...
                <div class="col-md-9">
                    ...
                    <div class="heading-block noborder">
                        ...
                        <a style="float:right" href="/<?= $this->lang?>/users/addAddress" class="button button-large button-rounded">Προσθήκη Στοιχείων</a>
                    </div>
                            ...
                            <div class="accordion" id="accordionExample">
								...
								foreach ($this->R->content as $address) {
                                    ...
                                    <div class="card-header" id="heading'.$i.'">
                                        <h2 class="mb-0">
                                            <a href="/'.$this->lang.'/users/billingAddress/'.$address['id'].'" class="btn btn-link">
                                                '.$address['address'].' '. $address['pobox'] .'
                                            </a>
                                            <a style="float: right" href="/'.$this->lang.'/users/deleteBilling?id='.$address['id'].'">X</a>
                                        </h2>
                                    </div>
