			...
			<div class="row clearfix">
				...
				<div class="col-md-9">
                    ...
                    <div class="heading-block noborder">
                        ...
                        <span><?=$this->T("account_addresses_menu");?></span>
                        <a style="float:right" href="/<?= $this->lang?>/users/addAddress" class="button button-large button-rounded"><?= $users['languages'][$this->lang]['address_add_new']; ?></a>
                    </div>
                            ...
                            <div class="accordion" id="accordionExample">
								...
								foreach ($this->R->content as $address) {
                                    ...
                                    <div class="card-header" id="headingOne">
                                        <h2 class="mb-0">
                                            <a href="/'.$this->lang.'/users/shippingAddress/'.$address['id'].'" class="btn btn-link">
                                                '.$address['address'].' '. $address['pobox'] .'
                                            </a>
                                            <a style="float: right" href="/'.$this->lang.'/users/deleteAddress?id='.$address['id'].'">X</a>
                                        </h2>
                                    </div>
                                </div>';
									$i++;
