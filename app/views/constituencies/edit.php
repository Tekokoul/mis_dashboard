...
<header class="page-header page-header-left-inline-breadcrumb">
    <h2 class="font-weight-bold text-6"><a href="<?=$this->L("constituencies/list")?>" ><?= display($data['meta_name']); ?></a></h2>
...
<form class="ecommerce-form action-buttons-fixed" action="<?=$this->L("constituencies/edit_update")?>" method="post">
...
<script>
    var constituency_id = <?=$data['data']['id'];?>;
</script>