<?php
//debug($data);
$page_link_prefix = "constituencies/list";
$suffix_terms = [];
                    ...
                    <div class="datatable-header">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                <a href="<?=$this->L("constituencies/add");?>" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add</a>
                            </div>
                            <?php
                            $html = "";
                        ...
                        <div class="table-responsive">
                            <table class="table table-ecommerce-simple table-borderless table-striped mb-0" id="datatable-list" style="min-width: 640px;">
								...
								foreach ($data['data'] as $row) {
									$link = "constituencies/edit/".$row['id'];
									?>
                                    <tr>
