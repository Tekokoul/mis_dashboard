...
//                                        $align = (isset($))
                                            print ($first)
                                                ? '<td data-title="'.$properties['title'].'"><a href="' . $this->L($link) . '"><strong>' . display_list_element($properties, $row[$field], $active) . '</strong></a></td>'
                                                : '<td data-title="'.$properties['title'].'">' . display_list_element($properties, $row[$field], $active) . '</td>';
                                            $first = false;
                                        }
                                    }
                                    ?>
