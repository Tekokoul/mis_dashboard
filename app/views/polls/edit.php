...
<header class="page-header page-header-left-inline-breadcrumb">
    <h2 class="font-weight-bold text-6"><a href="<?=$this->L("polls/list")?>" ><?= display($data['meta_name']); ?></a></h2>
...
<form class="ecommerce-form action-buttons-fixed" action="<?=$this->L("polls/edit_update")?>" method="post">
    ...
    <div class="row action-buttons nopadding">
        ...
        <div class="col-12 col-md-auto px-md-0 mt-3 mt-md-0">
            <a href="<?=$this->L('polls/list');?>" class="cancel-button btn btn-default btn-px-4 py-3 line-height-1">Back</a>
        </div>
    </div>
</form>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        var poll_id = <?=$data['data']['id'];?>;
        load_poll_details(poll_id);
    });
</script>