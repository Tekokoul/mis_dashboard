<?php
//debug($data);
$page_link_prefix = $this->controller_name."/list";
$suffix_terms = [];
                        ...
                        <form method="get" action="<?=$this->L($page_link_prefix);?>">
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                    <a href="<?=$this->L($this->controller_name."/add");?>" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add</a>
                                </div>
                                <?php
                                $html = "";
